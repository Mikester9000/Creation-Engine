...
_VARIANT_KEYWORDS = {
    ...
    "shop_marker": {"shop", "store", "merchant_sign"},
    "inn_marker": {"inn", "lodge", "tavern"},
    "enemy_spawn": {"spawn", "lair", "horde"},
    "ice_crystal": {"ice_crystal", "frost_crystal", "ice_shard"},
    "stone_tablet": {"tablet", "inscription", "rune_stone"},
    ...
    "dungeon_gate": {"dungeon", "sealed", "iron_gate"},
    ...
    "cave_fungus": {"fungus", "mushroom", "cave_plant"},
    ...
    "npc_elder": {"elder", "sage", "village_chief"},
    ...
    "enemy_undead": {"undead", "skeleton", "zombie", "revenant"},
}
